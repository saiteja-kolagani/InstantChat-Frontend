...
const MessageBar = () => {
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 gap-6 mb-5">
      ...
      <button
        className="bg-[#9b64af] rounded-md flex items-center justify-center p-5 gap-2 focus:border-none focus:outline-none hover:bg-[#764487] focus:bg-[#764487] transition-all duration-300 "
