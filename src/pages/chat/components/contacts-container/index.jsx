...
const ContactsContainer = () => {
  ...
  return (
    <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#54335c] border-r-2 border-[#54335c] w-full">
      <div className=" pt-3">
        <Logo />
      </div>
      <div className="my-5">
...
const Title = ({ text }) => {
  return (
    <h6 className="uppercase tracking-widest text-[#faf7fc] pl-10 font-light text-opacity-90 text-sm">
      {text}
    </h6>
  );
};
